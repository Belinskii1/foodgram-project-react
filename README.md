...
```
git clone https://github.com/Belinskii1/foodgram-project-react.git
```
...
или обратитесь к официальной документации https://docs.docker.com/compose/install/
```
...
* После успешной сборки на сервере выполните команды (только после первого деплоя):
    ...
    *Если файл не указывать, по умолчанию выберется ingredients.json*
    ...
    Или же зайдите в админку через супер пользователя и загрузите с помощью установленного пакета import/export
    ```
